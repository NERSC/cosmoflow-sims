...
#phys-params
Omega_m=` echo $uOmega_m | awk '{printf "%f", (1.+$1*0.10)* 0.306 }'` 
sigma_8=` echo $uSigma_8 | awk '{printf "%f", (1.+$1*0.10)* 0.815 }'` 
N_spec=`  echo $uN_spec  | awk '{printf "%f", (1.+$1*0.10)* 0.961 }'` 
